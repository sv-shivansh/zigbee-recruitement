...
export const register = ({name, email, phone, semester, branch, usn, ques1, ques2}) => async dispatch => {
    const config = {
        headers: {
            'Content-Type': 'application/json'
        }
    }
    const body = JSON.stringify({name, email, phone, semester, branch, usn, ques1, ques2})
    try{
